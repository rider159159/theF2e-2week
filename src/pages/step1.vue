<template>
  <section>
    ...
    <div class="w-full flex flex-col items-center pt-128px">
      <Step></Step>
      <div class="w-full py-124px px-20%">
        ...
        <div v-if="fileName.length > 0" class="w-full flex flex-col items-center justify-center text-5 mb-6">
          ...
          <router-link to="/step2" class="font-bold laFont text-24px mr-2 bg-secondary1 w210px h50px flex justify-center text-white items-center rounded-4px border-1px border-#000 hover:shadow-[4px_4px_0px_#000] duration-300" > 下一步</router-link> 
        </div>
